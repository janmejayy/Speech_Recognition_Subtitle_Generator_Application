...
path = "/Users/jay/Documents/FeatureExtraction/Sheet/"
label_path = "/Users/jay/Documents/DisserationProject/lrs2_v1_partaa/mvlrs_v1/main"
...
for folder in os.listdir(path):
    ...
    if os.path.isdir(folder_path):
        ...
        # Skip hidden files
        print(f"Skipping file: {folder_path}")
        continue
...
np.save('/Users/jay/Documents/DataExtraction/data.npy', data)
np.save('/Users/jay/Documents/DataExtraction/label.npy', labels)
