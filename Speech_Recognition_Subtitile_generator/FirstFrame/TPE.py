...
def TPE(picturepathF,mouth_centroid_xF, mouth_centroid_yF,ROI_mouthF,widthGF,heightGF):
    ...
    search_spaceH = {
        "Hkernel_size": hyperopt.hp.quniform('Hkernel_size', 10, 18, 1),
        "Hwavelength": hyperopt.hp.quniform('Hwavelength', 10, 18, 1),
        "Hsig": hyperopt.hp.quniform('Hsig', 4, 7, 1),
        "Hgamma": hyperopt.hp.quniform('Hgamma', 0.4, 0.7,0.1)
    }
